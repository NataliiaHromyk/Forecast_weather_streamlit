...
import numpy as np
import joblib
!pip install --quiet gdown && gdown --folder https://drive.google.com/drive/folders/1KEwUrqG3iVpihYfM4_CSwz1hsQTAaxQZ -O ./streamlit
...
# Load metadata
meta = load_metadata("data/weatherAUS.csv")
